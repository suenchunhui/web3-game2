...
export default function Mintpage(props) {
    ...
    const { web3Auth, provider, isLoading, user, createContract, getAccounts, pureProvider } = useWeb3Auth()
                        ...
                        <SimpleGrid spacing={10} row={1} columns={2}>
                            <Card _hover={{ transform: "scale(1.10)" }}
                                ...
                                <CardHeader>
                                    ...
                                    <Text>What Password will you crack with those words ?</Text>
                                </CardHeader>
                            ...
                            <Button disabled={loadingTX} onClick={() => mintNFT(localProvider)}
                                ...
                                style={{ marginTop: '140px' }} className={"max-w-4xl my-10"}> {!loadingTX && <div className="loader"> Mint Words </div>}
