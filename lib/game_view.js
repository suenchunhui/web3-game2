...
const GameView = function(game, ctx, setSongFn, setWelcomeHidden) {
  this.game = game;
  this.ctx = ctx;
  ...
  this.setSongFn = setSongFn;
  this.setWelcomeHidden = setWelcomeHidden;
};

GameView.prototype.loadGame = function() {
  this.setSongFn(evt => {
console.log("d333", evt, this);
    this.game.songName = "Ode to Joy"; //evt.target.innerHTML;

    //event.preventDefault();
    //$('.welcome').addClass('hidden');
    this.setWelcomeHidden(true);
